...
<form class="form-horizontal" action="#" method="POST" autocomplete="off">
	<fieldset class="panel" id="fs-account">
        ...
        <p><span class="label label-danger red">{l s='Important' mod='bpostshm'}</span></p>
				<p>
		...
		<div class="clear"></div>
		<div class="form-group">
			<label class="control-label col-lg-3" for="account_id_account">{l s='Account ID' mod='bpostshm'}</label>
		...
		<div class="clear"></div>
		<div class="form-group">
			<label class="control-label col-lg-3" for="account_passphrase">{l s='Passphrase' mod='bpostshm'}</label>
			<div class="margin-form col-lg-9">
		...
		<div class="clear"></div>
		<div class="form-group">
			<label class="control-label col-lg-3" for="account_api_url">{l s='API URL' mod='bpostshm'}</label>
			<div class="margin-form col-lg-9">
    ...
    {assign var="sd_id" value="sd-$key"}
		<div class="form-group">
			<label class="control-label col-lg-3" for="{$sd_id|escape}">{$details.title|escape}</label>
			<div class="margin-form col-lg-9">
...
<form class="form-horizontal" action="#" method="POST" autocomplete="off">
	<fieldset class="panel" id="fs-delopts">
      ...
      {foreach $delivery_options as $dm => $options}
			<div id="dm-{$dm|intval}">
				<span class="control-label col-lg-3">{l s=$options['title'] mod='bpostshm'}</span>
				<div class="margin-form col-lg-9">
					<table>
            ...
            {/foreach}
				...
				<div class="margin-form col-lg-9 col-lg-offset-3">
					<p class="preference_description help-block">
            {foreach $options['opts'] as $key => $opt}
						<b>{$delivery_options_info[$key]['title']|escape}</b>
						: {$delivery_options_info[$key]['info']|escape}
						<br/>
            {/foreach}
					</p>
				</div>
...
<form class="form-horizontal" action="#" method="POST" autocomplete="off">
	<fieldset class="panel" id="fs-delivery-set">
		...
		<div class="form-group">
			<span class="control-label col-lg-3">{l s='Display delivery date' mod='bpostshm'}</span>
			<div class="margin-form col-lg-9">
      ...
      {if isset($choose_delivery_date)}
			<div class="form-group">
				<span class="control-label col-lg-3">{l s='Choose delivery date' mod='bpostshm'}</span>
				<div class="margin-form col-lg-9">
						<span class="switch prestashop-switch fixed-width-lg">
        ...
        {if isset($num_dates_shown)}
				<div class="form-group">
					<span class="control-label col-lg-3">{l s='Number of delivery dates shown' mod='bpostshm'}</span>
					<div class="margin-form col-lg-9">
      ...
      {if isset($ship_delay_days)}
			<div class="form-group">
				<span class="control-label col-lg-3">{l s='Days between order and shipment' mod='bpostshm'}</span>
				<div class="margin-form col-lg-9">
      ...
      {if isset($cutoff_time)}
			<div class="form-group">
				<span class="control-label col-lg-3">{l s='Next day delivery allowed until' mod='bpostshm'}</span>
				<div class="margin-form col-lg-9">
      ...
      {if isset($hide_date_oos)}
			<div class="form-group">
				<span class="control-label col-lg-3">{l s='Hide delivery date when out of stock' mod='bpostshm'}</span>
				<div class="margin-form col-lg-9">
						<span class="switch prestashop-switch fixed-width-lg">
...
<form class="form-horizontal" action="#" method="POST" autocomplete="off">
	<fieldset class="panel" id="fs-label-set">
		...
		<div class="form-group">
			<span class="control-label col-lg-3">{l s='Use PrestaShop to manage labels' mod='bpostshm'}</span>
			<div class="margin-form col-lg-9">
					<span class="switch prestashop-switch fixed-width-lg">
      ...
      {if isset($order_states)}
			<div class="form-group">
				<span class="control-label col-lg-3">{l s='Treated order state' mod='bpostshm'}</span>
				<div class="margin-form col-lg-9">
      ...
      {/if}
			...
			<div class="clear"></div>
			<div class="form-group">
				<span class="control-label col-lg-3">{l s='Mark printed order as treated' mod='bpostshm'}</span>
				<div class="margin-form col-lg-9">
						<span class="switch prestashop-switch fixed-width-lg">
			...
			<div class="clear"></div>
			<div class="form-group">
				<span class="control-label col-lg-3">{l s='Label format' mod='bpostshm'}</span>
				<div class="margin-form col-lg-9">
					<p class="radio">
			...
			<div class="clear"></div>
			<div class="form-group">
				<span class="control-label col-lg-3">{l s='Retour label' mod='bpostshm'}</span>
				<div class="margin-form col-lg-9">
						<span class="switch prestashop-switch fixed-width-lg">
			...
			<div class="clear"></div>
			<div class="form-group">
				<span class="control-label col-lg-3">{l s='Track & Trace integration' mod='bpostshm'}</span>
				<div class="margin-form col-lg-9">
						<span class="switch prestashop-switch fixed-width-lg">
...
<form class="form-horizontal" action="#" method="POST" autocomplete="off">
	<fieldset class="panel" id="fs-intl-set">
		<div class="form-group">
			<span class="control-label col-lg-3">{l s='International delivery' mod='bpostshm'}</span>
			<div class="margin-form col-lg-9">
				<p class="radio">
